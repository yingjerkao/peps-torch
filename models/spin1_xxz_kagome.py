...
class S1_KAGOME_XXZ():
    ...
    def __init__(self, delta= 1., h = 0, j1=0., j1sq=0., j2=0., j2sq=0., jtrip=0., jperm=0., global_args=cfg.global_args):
        r"""
        ...
        self.h_triangle= self.j1*SSnn_t + self.j1sq*SS2nn_t + self.jtrip*SxSS_t \
            + self.jperm * permute_triangle + (self.jperm * permute_triangle_inv).conj()+ self.h*mag_field
